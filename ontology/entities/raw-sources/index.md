...
- Survey 原文入口（文档：`ontology/entities/raw-sources/files/A survey of LLM-augmented knowledge graphs for advanced complex product design.pdf`）：[[ontology/entities/raw-sources/files/A survey of LLM-augmented knowledge graphs for advanced complex product design.pdf]]
  - object_semantics: survey 原始 PDF 文件实例，用于 provenance 回查。
  - status: serving-ready
