...
- `[[知识图谱推理问答]] --supported_by--> [[intermediate/papers/PathMind.sections|PathMind.sections]]`
  - reason: 知识图谱推理问答场景定位由 sections 缓存支撑。
  - evidence: [[intermediate/papers/PathMind.sections|PathMind.sections]] §4、§7
